...
typedef struct workflow_action_ref { char scene_name[WORKFLOW_MAX_NAME]; char source_uuid[WORKFLOW_MAX_NAME]; char source_name[WORKFLOW_MAX_NAME]; char filter_name[WORKFLOW_MAX_NAME]; char filter_id[WORKFLOW_MAX_NAME]; char filter_uuid[WORKFLOW_MAX_NAME]; workflow_move_kind_t kind; workflow_scene_completion_t scene_completion; } workflow_action_ref_t;
