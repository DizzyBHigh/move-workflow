...
private:
    ...
    workflow_editor_sidebar_callbacks callbacks_;QLineEdit *search_=nullptr;QListWidget *nodes_=nullptr,*workflowNodes_=nullptr;QPushButton *addTrigger_=nullptr,*addNode_=nullptr,*edit_=nullptr,*copy_=nullptr,*paste_=nullptr,*duplicate_=nullptr,*remove_=nullptr;
};
}
