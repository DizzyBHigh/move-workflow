...
private:
    ...
    void updateButtonState(){const bool selected=scene_&&scene_->selectedNode();workflow_editor_sidebar_set_selection_state(sidebar_,selected,workflow_clipboard_has_data());workflow_editor_sidebar_set_workflow_nodes(sidebar_,scene_->nodes(),selected?scene_->selectedNode():nullptr);workflow_editor_properties_set_node(properties_,selected?scene_->selectedNode():nullptr);}
