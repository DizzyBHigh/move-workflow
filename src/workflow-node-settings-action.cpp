...
void NodeSettingsDialog::buildActionEditor(QWidget *parent,QVBoxLayout *layout)
{
    ...
    const QString savedSource=QString::fromUtf8(wf->action.scene_name); const QString savedFilterId=QString::fromUtf8(wf->action.filter_id);
    populateSources(savedSource); populateFilters(savedFilterId);
